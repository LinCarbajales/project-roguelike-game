export const LEVELS = [
  ...
  },
  {
    ...
    enemies: [
      { symbol: 'g', name: 'goblin',color: '#ff6600', hp: 10, attack: 4, defense: 1, visionRadius: 6, count: 3 },
  ...
  },
  {
    ...
    enemies: [
      ...
      { symbol: 'o', name: 'orco', color: '#ff0000', hp: 20, attack: 5, defense: 2, visionRadius: 8, count: 2 }
    ],
    potions: 2
  }
];
